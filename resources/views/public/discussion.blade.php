            ...
            @foreach ($posts as $post)
                <li class="forum-post" data-id="{{ $post->id }}">
                    ...
                    >
                        ...
                        <button class="forum-post-delete-alert-confirm" type="submit">
                            @lang('Yes delete it')
                        </button>
                    </form>
                            ...
                            <div class="forum-post-content-wrapper">
                                <div class="forum-post-content-info">
                                    <span class="forum-post-content-info-container">
                                        <span class="forum-post-content-info-name">
                                            {{ $post->user->first_name . ' ' . $post->user->last_name }}
                                        </span>
                                        <span class="forum-post-content-info-date">
...
{{ old('body') }}</textarea
                    ...
                    <div class="forum-discussion-actions forum-actions">
                            ...
                            <div class="forum-discussion-actions-notification forum-actions-notification">
                                ...
                                <div class="form-check form-switch">
                                    <input
                                        ...
                                        @if (!Auth::guest() && $discussion->users->contains(Auth::user()->id))
                                            {{ 'checked' }}
                                            @endif
                                    />
                        ...
                        <button class="btn btn-success" type="submit" id="submit_response">
                            <i class="forum-new"></i>
                            @lang('Submit response')
                        </button>
                    </div>
                </div>
            </form>
