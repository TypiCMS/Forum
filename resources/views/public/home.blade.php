                    ...
                    @if ($categories->count() > 0)
                        <ul class="forum-sidebar-category-list">
                            <li class="forum-sidebar-category-item forum-sidebar-category-item-all">
                                <a
                                    class="forum-sidebar-category-item-link {{ ! isset($currentCategory) ? 'active' : '' }}"
                                    href="{{ route($lang . '::forum.home') }}"
                                >
                                    <svg
                                        class="forum-sidebar-category-item-icon"
                                        width="20"
                                        height="20"
                                ...
                                <li class="forum-sidebar-category-item">
                                    ...
                                    >
                                        <span class="forum-sidebar-category-item-icon">
                                            <span
                                                class="forum-sidebar-category-item-box"
                        ...
                        <ul class="forum-discussion-list">
                            @foreach ($discussions as $discussion)
                                <li class="forum-discussion">
                                    <a
                                        class="forum-discussion-link"
                                        href="{{ route($lang . '::forum.discussion.showInCategory', [$discussion->category->slug, $discussion->slug]) }}"
                                    >
                                        <div
                                            class="forum-discussion-avatar"
                                            style="
                                                background-color: #{{ ForumHelper::stringToColorCode($discussion->user->first_name) }};
                                            "
                                        >
                                        ...
                                        <div class="forum-discussion-content">
                                            <h2 class="forum-discussion-content-title">
                                                {{ $discussion->title }}
                                                <div
                                                    class="forum-discussion-content-category"
                                        ...
                                        <div class="forum-discussion-count">
                                            <svg
                                                class="forum-discussion-count-icon"
                                                fill="currentColor"
                                                width="16"
                                                height="16"
                                                viewBox="0 0 1792 1792"
