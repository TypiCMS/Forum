        ...
        <div class="forum-container">
            <div class="row">
                <div class="forum-sidebar col-md-3">
                    <a class="forum-sidebar-create-button" href="{{ isset($currentCategory) ? route($lang . '::forum.discussion.createInCategory', $currentCategory->slug) : route($lang . '::forum.discussion.create') }}" class="btn btn-primary btn-block">
                        <i class="forum-new"></i>
                        @lang('New discussion')
                    </a>
