...
<item-list
    ...
    <template slot="columns" slot-scope="{ sortArray }">
        ...
        <item-list-column-header name="views" sortable :sort-array="sortArray" :label="$t('Views')"></item-list-column-header>
        <item-list-column-header name="forum_category_id" sortable :sort-array="sortArray" :label="$t('Category')"></item-list-column-header>
    </template>
